<template>
  <AdminLayout title="Buat WordCloud">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
          <h2 class="text-xl font-semibold text-gray-900">Informasi WordCloud</h2>
          <p class="mt-1 text-sm text-gray-600">Tambahkan kata dan nilai untuk membuat wordcloud interaktif</p>
        </div>
        ...
        <form @submit.prevent="submitForm" class="p-6 space-y-6">
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Contoh: Topik Diskusi Utama"
          ...
          <div>
            ...
            <textarea 
              ...
              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
              rows="3"
              placeholder="Jelaskan konteks atau sumber kata-kata ini..."
            ></textarea>
          </div>
